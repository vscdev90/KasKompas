...
export default function Sidebar() {
  ...
  return (
    <aside className="w-64 min-h-screen bg-gradient-to-b from-slate-800 to-slate-900 flex flex-col shrink-0">
      ...
      <div className="px-3 pb-5">
        <Link
          ...
          className="flex items-center gap-3 px-4 py-3 rounded-xl text-slate-400 hover:bg-white/8 hover:text-white text-sm font-medium transition-all"
        >
